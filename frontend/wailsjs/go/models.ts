export namespace app {
	...
	export class EnergyDay {
	    ...
	    static createFrom(source: any = {}) {
	        return new EnergyDay(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.day = source["day"];
	        this.cpuKWh = source["cpuKWh"];
	        this.gpuKWh = source["gpuKWh"];
	        this.kwh = source["kwh"];
	        this.kgCO2 = source["kgCO2"];
	    }
	}
	export class EnergyInfo {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.cpuWatts = source["cpuWatts"];
	        this.gpuWatts = source["gpuWatts"];
	        this.gridG = source["gridG"];
	        this.totalKWh = source["totalKWh"];
	        this.cpuKWh = source["cpuKWh"];
	        this.gpuKWh = source["gpuKWh"];
	        this.totalKgCO2 = source["totalKgCO2"];
	        this.todayKWh = source["todayKWh"];
	        this.todayKgCO2 = source["todayKgCO2"];
	        this.carKm = source["carKm"];
	        this.gpuModelled = source["gpuModelled"];
	        this.days = this.convertValues(source["days"], EnergyDay);
	    }
