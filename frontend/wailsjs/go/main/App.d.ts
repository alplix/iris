...
export function AssistantAsk(arg1:string):Promise<assistant.Reply>;

export function AssistantAvailable():Promise<boolean>;

export function AssistantCancel(arg1:string):Promise<void>;

export function AssistantConfirm(arg1:string):Promise<void>;

export function AssistantEnabled():Promise<boolean>;

export function AssistantHistory():Promise<Array<tilvar.Message>>;

export function AssistantReset():Promise<void>;
...
export function SetAssistantEnabled(arg1:boolean):Promise<void>;
